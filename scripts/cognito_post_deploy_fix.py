...
pool_ids = [pool["Name"]
            for pool in pool_ids_json["UserPools"] if poolname in pool["Name"]]
# print(pool_ids)
...
user_pool_client_CallbackURLs = [url.lower()
                                 for url in user_pool_client_CallbackURLs]
user_pool_client_LogoutURLs = [url.lower()
                               for url in user_pool_client_LogoutURLs]
